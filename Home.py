...
h1 { font-size: 2.2rem; font-weight: 700; line-height: 1.25; margin-bottom: 1.2rem; color: #fff; }
h1 span { background: linear-gradient(135deg, #4F8BF9, #a78bfa); -webkit-background-clip: text; -webkit-text-fill-color: transparent; }
.sub { color: #718096; font-size: 0.95rem; line-height: 1.75; margin-bottom: 2.5rem; }
.feature { display: flex; align-items: flex-start; gap: 1rem; margin-bottom: 1.4rem; }
.icon { width: 40px; height: 40px; border-radius: 10px; display: flex; align-items: center; justify-content: center; font-size: 1rem; flex-shrink: 0; }
...
.stats { display: flex; gap: 2.5rem; margin-top: 2.5rem; padding-top: 2rem; border-top: 1px solid rgba(255,255,255,0.06); }
.stat-num { font-size: 1.5rem; font-weight: 700; color: #fff; }
.stat-label { font-size: 0.7rem; font-weight: 600; text-transform: uppercase; letter-spacing: 0.07em; color: #4A5568; margin-top: 0.2rem; }
</style>
</head>
<body>
<div class="badge"><div class="badge-dot"></div><span class="badge-text">Live Analytics Platform</span></div>
...
<div class="feature">
    ...
    <div><div class="feat-title">Market Basket Analysis</div><div class="feat-sub">Apriori & FP-Growth association rule mining</div></div>
</div>
<div class="feature">
    <div class="icon icon-purple">👥</div>
    <div><div class="feat-title">Customer Segmentation</div><div class="feat-sub">RFM scoring with KMeans clustering</div></div>
</div>
<div class="feature">
    <div class="icon icon-green">📈</div>
    <div><div class="feat-title">Sales Dashboard</div><div class="feat-sub">Revenue trends, top products, country breakdown</div></div>
</div>
<div class="stats">
    <div><div class="stat-num">541K+</div><div class="stat-label">Transactions</div></div>
    <div><div class="stat-num">76</div><div class="stat-label">Rules Mined</div></div>
    <div><div class="stat-num">4,338</div><div class="stat-label">Customers</div></div>
</div>
</body>
</html>
""", height=700)
...
1. Go to **Upload** in the sidebar — upload your store's transaction CSV
2. Go to **Market Basket** — see which products are bought together
3. Go to **Dashboard** — see sales metrics, revenue trends and top products
4. Go to **Segmentation** — see customer segments (Premium, Regular, Dormant)

### Supported CSV Formats
- ✅ Standard transaction CSV (one row per item sold)
- ✅ Basket format CSV (one row per order, items listed across columns)
- ✅ List format CSV (products stored as a list in one column)
- ✅ Any column names — our smart detector maps them automatically
""")
